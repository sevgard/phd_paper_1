...
leg_4 = ax4.legend()
plt.show()
fig1.savefig('images/perf_means_var.png')
...
leg_4 = ax34.legend()
plt.show()
fig3.savefig('images/perf_mean_j_var.png')
...
for i in range(30):
    ...
    list_pi_m_t.append((j, pi_m_t(mean_j)))
...
leg_4 = ax44.legend()
plt.show()
fig4.savefig('images/perf_st_dev_var.png')
...
leg_4 = ax54.legend()
plt.show()
fig5.savefig('images/perf_rho_var.png')
...
leg_4 = ax64.legend()
plt.show()
fig6.savefig('images/perf_psi_var.png')
